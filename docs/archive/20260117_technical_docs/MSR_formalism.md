# MSR (Martin-Siggia-Rose) Formalism for Stochastic TRD
...
```
ℒ_TRD = ℒ_Dirac + ℒ_Kuramoto + ℒ_interaction
```
...
## 2. MSR Formalism for Stochastic TRD
...
The full MSR action for stochastic TRD:
...
The stochastic TRD could be realized in:
...
The MSR formalism provides a rigorous framework for stochastic TRD that:
