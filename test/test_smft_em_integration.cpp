...
// Test integration of Stückelberg EM into SMFTEngine
...
/**
 * Test: Verify Stückelberg EM integration in SMFTEngine
 *
 * Expected behavior:
 * 1. SMFTEngine initializes with StuckelbergEM
...
int main(int argc, char* argv[]) {
    std::cout << "=== TEST: SMFTEngine + Stückelberg EM Integration ===" << std::endl;
    std::cout << std::endl;

    // Initialize Nova
    NovaConfig config{};
    config.name = "SMFT EM Test";
    ...
    if (all_pass) {
        std::cout << "✅ SUCCESS: Stückelberg EM fully integrated into SMFTEngine!" << std::endl;
