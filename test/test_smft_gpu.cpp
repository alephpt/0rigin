/**
 * Test Program for SMFT GPU Pipeline
 *
 * Validates that the GPU compute pipelines are working correctly:
 * 1. Creates SMFTEngine instance
...
// NovaConfig is already included via SMFTEngine.h -> Nova.h -> config.h

int main() {
    std::cout << "SMFT GPU Pipeline Test\n";
    std::cout << "======================\n\n";
