 ...
 * @brief Test stochastic TRD evolution with Dirac-Kuramoto coupling
 *
 ...
 */
void addGaussianWavepacket(TRDEngine& engine, uint32_t Nx, uint32_t Ny,
                           float cx, float cy, float sigma) {
    // Note: This would require adding a method to TRDEngine to set spinor field
    // For now, we rely on the default initialization in TRDEngine::initialize
...
void saveEvolutionData(const std::string& filename,
    ...
    file << "# Stochastic TRD Evolution Data\n";
...
int main(int argc, char* argv[]) {
    std::cout << "===============================================\n";
    std::cout << "Stochastic TRD Particle Evolution Test\n";
    std::cout << "===============================================\n\n";
    ...
    NovaConfig config;
    config.name = "TRD Stochastic Test";
    ...
    // 2. Create and initialize TRD engine
