...
/**
 * TRDDescriptorManager - Vulkan Descriptor Management for TRD Engine
 *
 ...
 */
class TRDDescriptorManager {
public:
    /**
     * Constructor
     * @param device Vulkan logical device
     */
    explicit TRDDescriptorManager(VkDevice device);
    ...
    TRDDescriptorManager(const TRDDescriptorManager&) = delete;
    TRDDescriptorManager& operator=(const TRDDescriptorManager&) = delete;
    TRDDescriptorManager(TRDDescriptorManager&&) = delete;
    TRDDescriptorManager& operator=(TRDDescriptorManager&&) = delete;
