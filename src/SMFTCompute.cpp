...
void SMFTCompute::dispatchCompute(VkPipeline pipeline,
...
void SMFTCompute::dispatchKuramoto(VkPipeline pipeline,
                                  VkPipelineLayout layout,
                                  VkDescriptorSet descriptorSet,
                                  const void* pushConstants,
                                  size_t pushSize,
...
void SMFTCompute::dispatchSyncField(VkPipeline pipeline,
                                   VkPipelineLayout layout,
                                   VkDescriptorSet descriptorSet,
                                   const void* pushConstants,
                                   size_t pushSize,
...
void SMFTCompute::dispatchGravityField(VkPipeline pipeline,
                                      VkPipelineLayout layout,
                                      VkDescriptorSet descriptorSet,
                                      const void* pushConstants,
                                      size_t pushSize,
...
void SMFTCompute::dispatchDiracEvolution(VkPipeline pipeline,
                                        VkPipelineLayout layout,
                                        VkDescriptorSet descriptorSet,
                                        const void* pushConstants,
                                        size_t pushSize,
...
void SMFTCompute::dispatchAccumulation(VkPipeline pipeline,
                                      VkPipelineLayout layout,
                                      VkDescriptorSet descriptorSet,
                                      const void* pushConstants,
                                      size_t pushSize,
...
void SMFTCompute::fillBuffer(VkBuffer buffer, uint32_t value, VkDeviceSize size) {
    if (!_isRecording) return;
...
void SMFTCompute::insertMemoryBarrier() {
    if (!_isRecording) return;
...
void SMFTCompute::insertBufferBarrier(VkBuffer buffer,
...
bool SMFTCompute::submitBatch(bool waitForCompletion) {
...
void SMFTCompute::calculateWorkgroups(uint32_t width, uint32_t height,
