...
MSFTDescriptorManager::MSFTDescriptorManager(VkDevice device)
    : _device(device) {
}

MSFTDescriptorManager::~MSFTDescriptorManager() {
    destroyAll();
}

VkDescriptorPool MSFTDescriptorManager::createDescriptorPool(
    uint32_t maxSets,
...
VkDescriptorSetLayout MSFTDescriptorManager::createDescriptorSetLayout(
...
VkDescriptorSet MSFTDescriptorManager::allocateDescriptorSet(
...
void MSFTDescriptorManager::updateDescriptorSet(
...
VkDescriptorSetLayoutBinding MSFTDescriptorManager::createBinding(
    uint32_t binding,
...
void MSFTDescriptorManager::destroyDescriptorPool(VkDescriptorPool pool) {
...
void MSFTDescriptorManager::destroyDescriptorSetLayout(VkDescriptorSetLayout layout) {
...
void MSFTDescriptorManager::destroyAll() {
