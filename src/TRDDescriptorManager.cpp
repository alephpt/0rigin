...
TRDDescriptorManager::TRDDescriptorManager(VkDevice device)
    : _device(device) {
}

TRDDescriptorManager::~TRDDescriptorManager() {
    destroyAll();
}

VkDescriptorPool TRDDescriptorManager::createDescriptorPool(
    uint32_t maxSets,
...
VkDescriptorSetLayout TRDDescriptorManager::createDescriptorSetLayout(
...
VkDescriptorSet TRDDescriptorManager::allocateDescriptorSet(
...
void TRDDescriptorManager::updateDescriptorSet(
...
VkDescriptorSetLayoutBinding TRDDescriptorManager::createBinding(
    uint32_t binding,
...
void TRDDescriptorManager::destroyDescriptorPool(VkDescriptorPool pool) {
...
void TRDDescriptorManager::destroyDescriptorSetLayout(VkDescriptorSetLayout layout) {
...
void TRDDescriptorManager::destroyAll() {
