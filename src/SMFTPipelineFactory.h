...
/**
 * SMFTPipelineFactory - Factory class for creating Vulkan compute pipelines
 *
 * Extracts pipeline creation logic from SMFTEngine to follow Single Responsibility Principle.
 ...
 */
class SMFTPipelineFactory {
public:
    /**
     * Constructor
     * @param device Vulkan logical device for pipeline creation
     */
    explicit SMFTPipelineFactory(VkDevice device);
