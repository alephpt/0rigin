...
/**
 * SMFTBufferManager - Manages Vulkan buffer creation and memory allocation
 *
 * Extracts buffer management logic from SMFTEngine to reduce God Object complexity.
 * Handles creation, memory allocation, data transfer, and cleanup of Vulkan buffers.
 */
class SMFTBufferManager {
public:
    /**
     * Constructor
     ...
     */
    SMFTBufferManager(VkDevice device, VkPhysicalDevice physicalDevice);
