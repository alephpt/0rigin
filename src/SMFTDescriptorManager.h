...
/**
 * SMFTDescriptorManager - Vulkan Descriptor Management for SMFT Engine
 *
 ...
 */
class SMFTDescriptorManager {
public:
    /**
     * Constructor
     * @param device Vulkan logical device
     */
    explicit SMFTDescriptorManager(VkDevice device);

    /**
     * Destructor - cleans up all managed descriptor resources
     */
    ~SMFTDescriptorManager();

    // Disable copy/move semantics
    SMFTDescriptorManager(const SMFTDescriptorManager&) = delete;
    SMFTDescriptorManager& operator=(const SMFTDescriptorManager&) = delete;
    SMFTDescriptorManager(SMFTDescriptorManager&&) = delete;
    SMFTDescriptorManager& operator=(SMFTDescriptorManager&&) = delete;
