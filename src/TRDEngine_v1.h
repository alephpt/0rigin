...
/**
 * TRDEngine - Mass Synchronization Field Theory Physics Compute Engine
 *
 * Implements the core TRD equation: m(x) = Δ · R(x)
 * where:
...
public:
     ...
     * @param Delta Mass gap parameter (TRD control parameter)
