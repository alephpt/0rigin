...
/**
 * TRDBufferManager - Manages Vulkan buffer creation and memory allocation
 *
 * Extracts buffer management logic from TRDEngine to reduce God Object complexity.
 * Handles creation, memory allocation, data transfer, and cleanup of Vulkan buffers.
 */
class TRDBufferManager {
public:
    /**
     * Constructor
     ...
     */
    TRDBufferManager(VkDevice device, VkPhysicalDevice physicalDevice);
