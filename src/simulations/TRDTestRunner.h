#ifndef TRD_TEST_RUNNER_H
#define TRD_TEST_RUNNER_H
...
// Forward declare OutputManager in TRD namespace (no longer conflicts since class renamed to TRDCore)
namespace TRD { class OutputManager; }

/**
 * TRDTestRunner - Unified test execution framework for TRD
 *
 * Features:
 ...
 *
 * Usage:
 *   TRDTestRunner runner("config/timesync_validation.yaml");
 *   runner.initialize();
 *   runner.run();
...
public:
    ...
    /**
     * Initialize Nova and TRD engine
...
private:
    ...
    // Output management
    TRD::OutputManager* _output_manager;
